...
export const PROJECTS = [
  {
    ...
    description: "An interactive application built as part of the IST-687 course to predict electricity consumption based on property details and environmental factors. It includes features like data visualization and model-driven energy usage predictions.",
